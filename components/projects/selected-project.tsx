...
import { Candidate, TSimpleProject } from "@/types/types";
            ...
            {project.positions
              ...
              .map((position) => (
                <Accordion
                  ...
                  expanded={selectionCompleted[position.id]}
                >
                  <AccordionSummary
                  ...
                  <AccordionDetails>
                    ...
                    <Box
                      sx={{
                        display: selectionCompleted[position.id]
                          ? "block"
                          : "none",
                      }}
                    >
                      {selectedCandidates[position.id] != null &&
                        (() => {
                          ...
                          const candidate = candidates[position.id]?.find(
