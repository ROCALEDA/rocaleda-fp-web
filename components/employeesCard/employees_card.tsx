...
const EmployeeCard: React.FC<EmployeesProps> = ({ name, role, onEditClick, onDeleteClick }) => {
    return (
        <Card elevation={1} style={{ marginBottom: '10px', marginTop: '20px' }}>
            ...
            <PersonIcon color="secondary" style={{ marginRight: '10px' }}/>
                ...
                <div>
                    <IconButton onClick={() => onEditClick({ name, role })}>
                        <EditIcon color="primary" />
                    </IconButton>
                    <IconButton onClick={() => onDeleteClick(name)}>
