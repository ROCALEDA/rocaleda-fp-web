...
describe('<FormRegisterProyect />', () => {
  ...
  it('allows input of project name', () => {
    ...
    const input = getByLabelText('Nombre'); // Asume que tienes un label con este texto. Si no, ajusta según corresponda.
...
it('should reset the form when "Cancelar" button is clicked', () => {
    ...
    fireEvent.change(descriptionInput, { target: { value: 'Descripción del proyecto de prueba' } });
